  ...
  public static void main(String[] args) {
    try {
      ...
      Servlet[] handlers = new Servlet[] {
          new BoardServlet("board.json"),
          new BoardServlet("reading.json"),
          new BoardServlet("visit.json"),
          new BoardServlet("notice.json"),
          new BoardServlet("diary.json"),
          new MemberServlet("member.json"),
      };
